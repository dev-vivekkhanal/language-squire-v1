  ...
  return (
    <div className=" black-gradient">
      <div className="pb-10 flex flex-col md:flex-row  justify-between items-start pt-10 h-full gap-5 w-[95%] md:w-[85%] mx-auto ">
        <div className="flex-1 text-white w-[80%] md:w-full ">
      ...
      <div className="bg-white p-5 sm:py-10 md:py-16  -mt-20 rounded-lg translate-y-[50%] w-[90%] mx-auto flex  justify-around items-center gap-5 ">
        <div className="flex flex-col sm:flex-row justify-center items-center gap-2 sm:gap-4 ">
          ...
          <div>
            ...
            <h1 className="text-gray-400 text-xs sm:text-sm  text-center sm:text-left">
              Students Enrolled
            </h1>
          </div>
        </div>
